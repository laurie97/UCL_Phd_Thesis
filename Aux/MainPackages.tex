...
% Table of contents and table of figures commands
\usepackage[titles]{tocloft}
%\setlength\cftbeforechapskip{100pt}

\renewcommand\cftchapafterpnum{\vspace{-10pt}}
\renewcommand\cftsecafterpnum{\vspace{-10pt}}
\renewcommand\cftsubsecafterpnum{\vspace{-10pt}}
\renewcommand\cftfigafterpnum{\vspace{-10pt}}
\renewcommand\cfttabafterpnum{\vspace{-10pt}}
...
%\def\summer{\textit{Summer16+15}}
\def\summer{\textit{Summer16\_HighMass}}
\def\hm{\textit{Full16\_HighMass}}
\def\lm{\textit{Full16\_LowMass}}

%\def\bh{{\sc BumpHunter}}
%\def\dhunt{{\sc DeficitHunter}}

\def\bh{BumpHunter}
\def\dhunt{DeficitHunter}

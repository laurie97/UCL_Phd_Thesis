...
however this approach is not repeated here as it introduced dependencies on the choice of PDF model, meaning that the limits were not truly model independent.
...
\begin{figure}[!ht]
  \begin{center}
    ...
    \subcaptionbox{2 $b$-tag}{\includegraphics[width=0.49\linewidth, angle=0]{figs/Dibjet/ICHEP/lim-summer_systBkg_rel_bb.pdf}}\hspace{-0.2cm}
    \subcaptionbox{$\geq$1 $b$-tag}{\includegraphics[width=0.49\linewidth, angle=0]{figs/Dibjet/ICHEP/lim-summer_systBkg_rel_b.pdf}}
  \end{center}
  \vspace{-1em}
...
\begin{figure}[!b]
  \centering
  \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
  \subcaptionbox{$Z'$ boson,\hspace{1mm} 2 $b$-tag\vspace{12pt}}{\includegraphics[width=0.74\linewidth, angle=0]{figs/Dibjet/ICHEP/lim-zprime.pdf}\vspace{-12pt}}
  \subcaptionbox{$b^*$ quark,\hspace{1mm} $\geq$1 $b$-tag}{\includegraphics[width=0.74\linewidth, angle=0]{figs/Dibjet/ICHEP/lim-bstar.pdf}\vspace{-8pt}}
  \caption
...
\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{$b$-Jet Trigger Uncertainty}{\includegraphics[width=0.5\linewidth, angle=0]{figs/Dibjet/LowMass/lim-bTrigUncert.pdf}}\hspace{-0.2cm}
    \subcaptionbox{Background Uncertainties}{\includegraphics[width=0.5\linewidth, angle=0]{figs/Dibjet/LowMass/lim-lowmass_systBkg_rel.pdf}}
  \end{center}
  \vspace{-1em}
...
\begin{figure}[!ht]
  \centering
  \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
  \subcaptionbox{SSM and Leptophobic $Z'$ Boson\vspace{12pt}} {\includegraphics[width=0.8\linewidth, angle=0]{figs/Dibjet/LowMass/lim-zprime_SSM_BR.pdf}\vspace{-4pt}}  
  \subcaptionbox{DM $Z'$ Boson}                               {\includegraphics[width=0.8\linewidth, angle=0]{figs/Dibjet/LowMass/lim-zprime_DM_BR.pdf}}
  \caption

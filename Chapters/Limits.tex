...
\noindent
Therefore, the likelihood is expressed in terms of the set of nuisance parameters, $\vec{\theta}$:
\begin{equation}
...
The process of integrating over nuissance parameters is known as marginalisation.
...
while there is another widely used alternative known as the frequentist approach~\cite{lim-cowan}.
...
and the leptophobic $Z'$ boson is excluded at a generated mass of 1.5~TeV.
...
The signal subtracted background estimation is created for each generated mass point and

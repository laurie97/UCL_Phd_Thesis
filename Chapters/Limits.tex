...
function of the parameters which are considered as a sources of systematic uncertainty,
...
To do this a prior is introduced for each of the nuisance parameters, given by $\Pi(\vec{\theta})$,
...
the expected limit shows the sensitivity of limit setting phase.

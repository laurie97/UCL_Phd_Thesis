...
%  \end{center}
%  \caption{ The dijet mass distribution from QCD dijet simulation for the (a) 2 $b$-tag and (b) $\geq$1 $b$-tag,
...
However, one data-like distribution does not represent the full range of fluctuations that are possible.

...
hence if the 4 parameter dijet fit function cannot adequetely describe the background neither can the 3 parameter dijet fit function.
...
\item Identify an updated excess, by performing the \bh{} algorithm to the dijet mass spectrum using the updated background estimate created in Step 2.
...
\item If the updated excess is \textit{not} contained within the initial exclusion region,
      then the procedure returns to Step 1 using the updated excess region as the discrepant excess region.

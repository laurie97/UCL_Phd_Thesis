...
\begin{figure}[!ht]
  ...
  \vspace{-0.8em}
  \caption
      [The scaled and effective entries dijet mass spectrum
...
\begin{figure}[!ht]
  ...
  \vspace{-1em}
  \caption
      [The scaled dijet mass spectrum from QCD dijet simulation for the 2 and $\geq$1 $b$-tag category,
...
\begin{figure}[!ht]
  ...
  \vspace{-1em}
  \caption
      [The scaled dijet mass spectrum compared to the
        effective entries of the dijet mass spectrum 
...
\begin{figure}[!ht]
  ...
  \vspace{-1em}
  \caption
      [An illustration of the calculation of the \bh{} $p$-value for the search phase applied to data-like dijet mass spectra from a simulated QCD dijet sample.
        The \summer{} data-set event selection has been applied.]
      {The \bh{} test statistic observed when the search phase is applied to a data-like dijet mass spectrum from a simulated QCD dijet sample
...
\caption
    [The SWiFt search phase run on a 3~\ifb{} subset of the \lm{} data-set using
      the 4 and 5 parameter dijet fit function for a window half-width of 16.]
...
\caption
    [The  \bh{} \mbox{$p$-value} when performing the SWiFt search phase to
      a data-like dijet mass spectrum that has been injected with a sequential standard model $Z'$ with

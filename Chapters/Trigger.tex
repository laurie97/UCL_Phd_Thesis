...
Therefore, the low mass di-$b$-jet search presented in this thesis
uses only the 2016 data-set, which contains 88\% of the combined integrated luminosity and, as shown in Figure~\ref{fig:trig-bTrig_perf}, has an improved online $b$-tagging performance.

In addition, there are also significant difference between the $b$-tagging procedure used online and offline.
...
The $b$-performance triggers then run and record the output of the online $b$-tagging algorithms on all trigger jets with $|\eta|<2.5$ and
...
A residual kinematic bias with respect to leading jet-$\eta$ is still present;
...
Both the $b$-jet trigger aware GRL and the jet-level and event-level $b$-jet trigger efficiencies  presented in this section
are used by for all analyses at ATLAS utilising the $b$-jet trigger in 2016 data as reccomended by the ATLAS $b$-jet trigger group.

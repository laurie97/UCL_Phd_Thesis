...
to decide if a L1 trigger accept is given and thus events are passed on to the HLT.
...
\begin{figure}[!htb]
  \begin{center}
    \includegraphics[width=0.8\linewidth, angle=0]{figs/Detector/trigger_schem.png}
  \end{center}
  \vspace{-1em}
...
This chapter describes triggers used in the two di-$b$-jet searches presented in this thesis in Chapter~\ref{sec:evt}--\ref{sec:lim}.
...
In Run-2 the jet triggers are used at both the L1 and HLT level, which are described at the beginning of this section~\cite{trig-run2_proc}.
...
The HLT jet trigger, due to the larger time allowed for a trigger decision,
...
Firstly, a `fast'-tracking algorithm is run in the superset of the RoIs and
...
Finally, these precision tracks are used by the MV2 $b$-tagging algorithm, described in Section~\ref{sec:obj-bjets_MV2}, to identify $b$-jets.
...
The black line represents MV2c20 algorithm used in 2016 data-taking as described in Section~\ref{sec:obj-bjets_MV2}.
...
In 2015 data-taking the \verb|EFHist| algorithm is employed;
which groups all tracks in histogram based on the $z$ position of the track intersection with the beam-pipe,
...
The scale-factors for the $b$-jet trigger are to be applied in tandem with the offline $b$-tagging scale factors described in Section~\ref{sec:obj-bjets_calib}.
...
as this is set of operating points used in the low mass di-$b$-jet search; the $b$-tagging operating points used in di-$b$-jet searches are discussed in Chapter~\ref{sec:evt}.
...
This section will present the observation and investigation of discrepancies between the $b$-jet trigger efficiency measured in 2016 data and simulation.
...
To accurately reflect the full $b$-jet trigger efficiency %before the $b$-jet trigger GRL is applied
...
\begin{figure}[!htb]
  \begin{center}
    ...
    \subcaptionbox{Jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/trigger/Full_noGRL_eff_noHLTMatch_jetPt.pdf} }
    \subcaptionbox{Jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/trigger/Full_noGRL_eff_noHLTMatch_jetEta.pdf}}
  \end{center}
  \vspace{-1em}
...
equivalent online jet will with $\pT{} > 35$~GeV required to be reconstructed by the $b$-performance trigger. This bias is removed when offline--online matching is required.
...
%  \label{tab:trig-epochs}
%\end{table}
%For Epoch 1, the $\epsilon_{\text{PV}}$ is 100\% as shown in Figure~\ref{fig:Epoch1_bperf} for Period A.Figure~\ref{fig:Epoch1_eff} shows the $\epsilon_{b\text{Trig}}$ in Epoch 1,
...
\begin{figure}[!b]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Jet-\pT}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Trigger/Epoch1_noGRL_eff_jetPt.pdf} }
    \subcaptionbox{ $z_{\,\text{bs}}^{\text{\,online}}$}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Trigger/Epoch1_noGRL_eff_bs_online_vz.pdf} }
  \end{center}
  \vspace{-1em}
...
%\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{$\epsilon_{b\text{Trig}}$ against Vertex Class}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Trigger/Epoch1_noGRL_eff_vtxClass.pdf}}
    \subcaptionbox{Freq. of Offline Jets against Vertex Class}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Trigger/Epoch1_noGRL_nOff_vtxClass.pdf}}
  \end{center}
    \vspace{-1em}
...
the \verb|xPrmVtx| returns an dummy vertex which results in a low $b$-jet trigger efficiency.
...
This is the reason it was necessary to relax the requirement that offline jets must match online jets to see the full $b$-jet trigger efficiency in Figure~\ref{fig:trig-Full_noGRL_eff_noHLTMatch}.

\begin{figure}[!hb]
\begin{center}
  \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
  \subcaptionbox{Jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_eff_jetPt.pdf}}     
  \subcaptionbox{$z_{\,\text{bs}}^{\text{\,online}}$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_eff_bs_online_vz.pdf}}
  %\subcaptionbox{??}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_eff_jetEta.pdf}} \\
  %\subcaptionbox{??}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_eff_vtxClass.pdf}}
\end{center}
\vspace{-1em}
\caption[
...
\begin{center}
  \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
  \subcaptionbox{Leading jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_bPerfEff_leadingJet_jetPt.pdf}}
  \subcaptionbox{$z_{\,\text{bs}}^{\text{\,online}}$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_bPerfEff_leadingJet_bs_online_vz.pdf}}\\
  \subcaptionbox{Leading jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_noGRL_bPerfEff_leadingJet_jetEta.pdf}}
\end{center}
\vspace{-1em}
...
\begin{center}
  \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
  \subcaptionbox{Jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch3_noGRL_eff_jetPt.pdf}}
  \subcaptionbox{Jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch3_noGRL_eff_jetEta.pdf}} \\
  \subcaptionbox{$z_{\,\text{bs}}^{\text{\,online}}$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch3_noGRL_eff_bs_online_vz.pdf}}
  \subcaptionbox{Vertex Class}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch3_noGRL_eff_vtxClass.pdf}}
\end{center}
\vspace{-1em}
...
such that the events with low efficiency are removed. No such requirement is necessary for Epoch 3.
...
\begin{figure}[!b]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch1_GRL_bslt2mm_eff_jetPt.pdf} }
    \subcaptionbox{Jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch1_GRL_bslt2mm_eff_jetEta.pdf}}
  \end{center}
\vspace{-1em}
  \caption[
...
%\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Leading jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_GRL_bslt2mm_bPerfEff_leadingJet_jetPt.pdf} }
    \subcaptionbox{Leading jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Epoch2_GRL_bslt2mm_bPerfEff_leadingJet_jetEta.pdf}}
  \end{center}
\vspace{-1em}
  \caption[
...
\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_eff_jetPt.pdf}}
    \subcaptionbox{Jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_eff_jetEta.pdf}}\\
    \subcaptionbox{$z_{\,\text{bs}}^{\text{\,online}}$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_eff_bs_online_vz.pdf}}
    \subcaptionbox{Vertex Class}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_eff_vtxClass.pdf}}
  \end{center}
\vspace{-1em}
\caption[
...
%\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Leading jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_bPerfEff_leadingJet_jetPt.pdf}}
    \subcaptionbox{Leading jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_bPerfEff_leadingJet_jetEta.pdf}}
  \end{center}
\vspace{-1em}
\caption[
...
The remaining data/simulation differences are accounted by applying a jet-level and an event-level data/simulation scale factor.
...
The event level efficiency corrects for the observation that there are events in data that have a near zero efficiency as they don't contain a valid primary vertex.
...
It is known that despite the strict event selection there will inevitably
be non-$b$-jet contamination included in the sample of jets used.
The effect of the non-$b$-jet contamination on the measured $b$-jet trigger efficiency
...
\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{$b$-jet purity}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/purityMC_variations.pdf}}
    \subcaptionbox{$b$-jet trigger efficiency}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/effMC_uncert_purity.pdf}}
  \end{center}
\vspace{-1em}
...
%  \begin{center}
%    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
%    \subcaptionbox{Jet-\pT}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/PurityMC_jetPt.pdf}}
%    \subcaptionbox{Jet-$\eta$}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/PurityMC_jetEta.pdf}}
%  \end{center}
...
%  \begin{center}
%    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
%    \subcaptionbox{}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/EffMC_jetPt_trueB.pdf}}
%    \subcaptionbox{}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/EffMC_jetPt_2nonB.pdf}}
%  \end{center}
%  \caption{The 60\% operating point $b$-jet trigger efficiency with respect to the offline 70\% operating point
...
\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Non-$b$-jets}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/effMC_variations_LTrigEff.pdf}}
    \subcaptionbox{Inclusive jets}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/effMC_uncert_LTrigEff.pdf}}
  \end{center}
\vspace{-1em}
...
%  \begin{center}
%    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
%    \subcaptionbox{}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/effMC_jetPt_lowLTrigEff.pdf}}
%    \subcaptionbox{}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/effMC_jetPt_upLTrigEff.pdf}}
%  \end{center}
%  \caption{The 60\% operating point $b$-jet trigger efficiency with respect to the offline 70\% operating point
...
\item \textbf{Normalisation Fit}: A \textit{`normalised simulation'} efficiency is created by applying
  ...
  The lowest \pT{} bin is excluded from the fit as it has a discrepant data/simulation ratio compared to other low-\pT{} bins;
  although it should be noted that this discrepancy is consistent within uncertainties.
...
\item \textbf{Linear Correction Fit}:
  ...
  The linear correction factor is derived by performing a linear fit to the ratio of the $b$-jet trigger efficiency in data and the normalised simulation
  ...
  the maximum difference between the nominal fit and the systematic variations is taken as the uncertainty.
  Panel (c) of Figure~\ref{fig:bTrig_mcExtrap} shows the $b$-jet trigger efficiency in data compared to the corrected simulation,
...
\begin{center}
\captionsetup[subfigure]{aboveskip=0pt,justification=centering}
  \subcaptionbox{Normalisation fit} {\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_effFit_jetPt.pdf} }
  \subcaptionbox{Linear correction fit} {\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_effNormFit_jetPt.pdf}} \\
  \subcaptionbox{Linear correction uncertainties} {\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_effCorrShapeErr_jetPt.pdf}}
  \subcaptionbox{Quadratic fit } {\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/Full_GRL_bslt2mm_effCorrFitQuad_jetPt.pdf}}
  %\subcaptionbox{Extrapolation closure}{\includegraphics[width=0.47\linewidth, angle=0]{figs/Trigger/fullSys_EfficiencyComp_jetPt.pdf}}
\end{center}
\vspace{-0.8em}
...
Data statistical  uncertainties are considered for jet-$p_T <$ 240 \GeV{}
whilst the high-\pT{} extrapolation uncertainty are applied for jet-$p_T >$ 240 \GeV.
...
\end{tabular}
  \caption[The jet-level $b$-jet trigger efficiency data/simulation scale factor  as a function of jet-$p_{T}$ with total uncertainties and the contributions]
          {The jet-level $b$-jet trigger efficiency data/simulation scale factor (SF) as a function of jet-$p_{T}$
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[width=0.65\linewidth, angle=0]{figs/Trigger/fullSyst_EventEfficiency_leadingJetEta.pdf}
  \end{center}

...
%\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{$z_{\,\text{bs}}^{\text{\,online}}$,\\ \textit{xPrmVtx} vertex found}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Trigger/Epoch1_noGRL_eff_PVFound_jetPt.pdf}}

...
In this section the formation of hadronic jets from calorimeter cells is described,
...
\begin{figure}[!ht]
  \begin{center}
    ...
    \subcaptionbox{Jet-\pT} {\includegraphics[width=0.45\linewidth, angle=0]{figs/Objects/jets_uncert_JER_pt.pdf} }
    \subcaptionbox{Jet-\eta}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Objects/jets_uncert_JER_eta.pdf} }
  \end{center}
...
\begin{figure}[!ht]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Jet-\pT} {\includegraphics[width=0.45\linewidth, angle=0]{figs/Objects/jets_uncert_JES_pt.png} }
    \subcaptionbox{Jet-\eta}{\includegraphics[width=0.45\linewidth, angle=0]{figs/Objects/jets_uncert_JES_eta.png} }
  \end{center}

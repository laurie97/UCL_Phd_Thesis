...
The algorithms consider a set of four-momenta which are referred to as clusters;
...
\begin{figure}[!htb]
  \begin{center}
    ...
    \subcaptionbox{Jet-\pT{}} {\includegraphics[width=0.4\linewidth, angle=0]{figs/Objects/jets_uncert_JES_pt.pdf} }
    \subcaptionbox{Jet-\eta}{\includegraphics[width=0.4\linewidth, angle=0]{figs/Objects/jets_uncert_JES_eta.pdf} }
  \end{center}
 \vspace{-1em}

...
\item\textbf{In-situ calibration}:
  ...
  the reference objects are a photon, a $Z$ boson, or a set of calibrated jets.
  The reference objects are calibrated such that they have a well measured $p_T$;
...
\begin{figure}[!ht]
  ...
  \end{center}
  \vspace{-1em}
  \caption[Ratio of $b$-tagging efficiency in data and simulation for MV2c10 at the 77\% operating point as a function of jet-\pT{} in di-lepton $t\bar{t}$ events.]

...
The topoclusters are treated as massless objects as their energy is much larger than that of the hadrons that typically form a hadronic jet \footnote{\ Mostly light hadrons such as pions}.
...
\begin{figure}[!htb]
  \begin{center}
    ...
    \subcaptionbox{Jet-\pT{}} {\includegraphics[width=0.4\linewidth, angle=0]{figs/Objects/jets_uncert_JES_pt.png} }
    \subcaptionbox{Jet-\eta}{\includegraphics[width=0.4\linewidth, angle=0]{figs/Objects/jets_uncert_JES_eta.png} }
  \end{center}
 \vspace{-1em}
...
%\end{figure}
 ...
 \vspace{0.2em}
  \begin{center}      
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Jet-\pT{}} {\includegraphics[width=0.4\linewidth, angle=0]{figs/Objects/jets_uncert_JER_pt.pdf} }
    \subcaptionbox{Jet-\eta}{\includegraphics[width=0.4\linewidth, angle=0]{figs/Objects/jets_uncert_JER_eta.pdf} }
 \end{center}
 \vspace{-1em}
...
A $b$-tagged jet is required to have a MV2 output above a threshold cut to select jets that are likely to $b$-jets.
...
A calibration is performed to correct the modelling of $b$-tagging in simulation to the true $b$-tagging performance in data.

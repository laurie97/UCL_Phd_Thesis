...
\begin{figure}[!hbt]
  \begin{center}
    \includegraphics[width=0.8\linewidth, angle=0]{figs/Theory/qcd_gluon_loop.pdf}
  \end{center}
  \vspace{-1em}
  \caption[A schematic showing the gluon propagator with additional first order loops.]
  {A schematic showing the gluon propagator with additional first order loops~\cite{det-thesis_kate}.}
...
Therefore cross-section calculations involving an integral over all phase space will no longer diverge,

...
The first step of the procedure, known as regularisation, seperates the divergent and non-divergent terms of the cross-section calculation.
...
and setting $\mu_R = Q$ ensures that higher-order contributions cannot become large due to a dependence on $\mu_R$.

...
only tree-level diagrams have been considered, but there also exist higher-order diagrams.
...
Two such models that predict particles with preferential decays to $b$-quarks are discussed below.

...
\item\textbf{Electro-magnetic (EM) Force:}
  ...
  multiplied by the product of the charges of the two particles, where $\alpha_{EM} \sim$ 1/137.\vspace{0.5em} %\vspace{0.5em}
...
\item\textbf{Weak Force:} \\
  ...
  \mbox{($\text{Weak}/\text{EM} \sim 10^{-4}$)}.\vspace{0.5em} %\vspace{0.5em}

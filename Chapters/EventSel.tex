\chapter{Di-$b$-Jet Search: Analysis Introduction}
\label{sec:ana}
...
This chapter contains an outline of the analysis strategy and describes how the analysis will be presented within this thesis.
...
which form three proceeding chapters.
...
\item\textbf{Di-$b$-Jet Event Selection:} (\textit{Chapter~\ref{sec:evt}})\\
  ...
  Chapter~\ref{sec:evt} will provide details on the data-sets considered and the event selection used in the two di-$b$-jet searches.
  \vspace{0.8em}
...
\item\textbf{Search Phase:} (\textit{Chapter~\ref{sec:bkg}})\\
  ...
  It is useful to note that as part of these validation studies,
  it is shown that some regions of phase space cannot be adequetely described by the background estimation strategy.
  Hence, the validation studies shown in Chapter~\ref{sec:bkg} have an impact on the event selection used in Chapter~\ref{sec:evt},
  this will be clearly noted at the appropriate points in the text. 
  ...
  \caption[A cartoon illustrating the use of the dijet mass distribution in the search phase of a di-$b$-jet search.]
          {A cartoon illustrating the use of the dijet mass (\mjj) distribution in the search phase of a di-$b$-jet search.
            Shown is the smoothly falling distribution from QCD dijet production
...
\item\textbf{Limit Setting:} (\textit{Chapter~\ref{sec:lim}})\\
  ...
  then 95\% credibility level limits are set on the cross-section of the benchmark signal models as a function of mass.
...
\chapter{Di-$b$-Jet Search: Event Selection}
\label{sec:evt}
...
whilst minimising the number of background events selected,
such that the sensitivity of the di-$b$-jet search to a new resonance is maximised.

This chapter is organised in the following structure:
...
the details of the event selection used for both di-$b$-jet searches.
\vspace{0.8em}
...
\item\textbf{\hm{}}:\\
  ...
  However, as this analysis is to be published together with the \lm{} data-set,
  some analysis presentation decisions are affected by the \hm{} data-set analysis.
...
\begin{figure}[!hb]
  \begin{center}
    \includegraphics[width=0.86\linewidth, angle=0]{figs/Dibjet/ICHEP/evt-summer_flavcomp.pdf}
  \end{center}
  \vspace{-1.25em}
  \caption
...
%\begin{figure}[!ht]
  \begin{center}
    \includegraphics[width=0.4\linewidth, angle=0]{figs/Dibjet/LowMass/evt-flavcomp.pdf}
  \end{center}
  \vspace{-1.25em}
...
\begin{figure}[!htb]
  \begin{center}
    \captionsetup[subfigure]{aboveskip=0pt,justification=centering}
    \subcaptionbox{Signal acceptance multiplied \\by trigger efficiency}{\includegraphics[width=0.49\linewidth, angle=0]{figs/Dibjet/LowMass/evt-acc_ppt.pdf} }
...
% leading to a similar event tagging efficiency.

...
\begin{figure}[!ht]
  ...
  \caption[Integrated luminosity versus time delivered to and recorded by ATLAS during 2015 and 2016]
      {Integrated luminosity versus time delivered to (green) and recorded by ATLAS (yellow) during stable beams for $pp$ collisions at 13 TeV centre-of-mass energy in (a) 2015 and (b) 2016~\cite{det-ATLAS_lumi_twiki}.}
...
Each component of the ID consists of the barrel, which is made up of cylinders surrounding the beam-pipe,
and the end-caps, which are made up disks that lie perpendicular to beam-pipe on either end of the barrel to provide additional hits for large valus of absolute $|\eta|$.
...
The innermost component of the ID is the silicon pixel detector, which is made out of layers of silicon based pixel modules.
The pixel detector's barrel consists of 4 layers of surrounding the beam pipe providing 4 hits in the angular range $|\eta| < 1.7$,
and the end cap consists of 3 disks at either end of the detector to provide additional hits for $1.7 < |\eta| < 2.5$
%and a radial distance of \SI{33.25}{mm} to \SI{122.5}{mm} \cite{det-IBL_TDR,det-IBL_Talk}.
The high-granularity of the pixel detector \footnote{ The minimum size of the pixel modules in $R$-$\phi$ x $z$ is 50 x \SI{400}{\micro\metre^2} }, allows for high precision measurements,
with an intrinsic resolution for both barrel and end-cap of $\sim$\SI{10}{\micro\metre} in the $R$-$\phi$ plane and $\sim$\SI{115}{\micro\metre} in the z-direction. 

Moving radial outwards the next component of the ID is the Semi-Conductor Tracker.
The SCT barrel, comprises of 4 cylindrical layers of silicon micro-strips providing 4 hits in the range of $|\eta| < 1.4$.
The SCT end-cap comprises of 9 disks at either end of the detector to provide additional hits in the range  $1.4 < |\eta| < 2.5$,
%in the radial distance of 299 mm to 514 mm.
The SCT has an intrinsic resolution for both barrel and end-cap of $\sim$\SI{17}{\micro\metre} in $R-\phi$ plane and $\sim$\SI{580}{\micro\metre} in the z-direction. 

The outermost component of the ID is the Transition Radiation Tracker (TRT)
constructed of many \SI{4}{\mm} radius tubes filled with xenon with a anode wire through the centre.
...
the energy of the initial particle is inferred. 
...
and has a depth of 7.4 $\lambda$, meaning the majority of the hadronic shower is captured by either the LAr calorimeter or the Tile calorimeter.
...
The trigger muon chambers provide a quick position measurement in 3-dimensions which is used

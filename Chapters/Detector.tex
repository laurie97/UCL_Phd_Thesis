...
\begin{figure}[!htb]
  \begin{center}
    \includegraphics[width=0.8\linewidth, angle=0]{figs/Detector/ATLAS_schem.jpg}
  \end{center}
...
The absorber material used is the LAr calorimeter is lead;
...
meaning that the large number of charged particles in a lead atom (high-Z) will increase the rate of cascade processes and reduces the shower depth.

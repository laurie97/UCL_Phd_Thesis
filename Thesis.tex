...
\input{Aux/BibSettings}   % For bibliographies
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\title{\HUGE In the Search of Beauty:\\ \vspace{0.5em} \huge  Searches for New Physics using Pairs of Jets Containing one or two $b$-Jets \mbox{at the ATLAS Detector}}
\title{\Huge Searches for New Physics using Pairs of Jets Containing one or two $b$-Jets \mbox{at the ATLAS Detector}}
